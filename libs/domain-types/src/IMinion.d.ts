...
declare const ReconfigureError_base: new <A extends Record<string, unknown> = Record<string, unknown>>(args: import("effect/Types").Equals<A, Record<string, unknown>> extends true ? void : { readonly [P in keyof A as P extends "_tag" ? never : P]: A[P]; }) => import("effect/Cause").YieldableError & {
    readonly _tag: "ReconfigureError";
} & Readonly<A>;
/**
 ...
 */
export declare class ReconfigureError extends ReconfigureError_base<{
    reason: string;
    minionId: string;
}> {
}
...
//# sourceMappingURL=IMinion.d.ts.map