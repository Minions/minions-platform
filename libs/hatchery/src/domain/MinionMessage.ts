...
export interface ToolUseMessage {
  ...
  input: unknown;          // Tool input parameters (shape depends on the tool being invoked)
  timestamp: number;
  metadata?: Record<string, unknown>;
}
...
export interface ToolResultMessage {
  ...
  content: unknown;        // Tool execution result (shape depends on the tool being invoked)
