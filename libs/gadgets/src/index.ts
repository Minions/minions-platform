...
// Gadget types (file-backed executable functions)
export type {
  GadgetArgsSchema,
  GadgetPropertySchema,
  GadgetContext,
  GadgetResult,
  Gadget,
} from './Gadget';
export { isGadget } from './Gadget';

// Costume extensions (action groups + gadgets exposed by a costume)
export type {
  ExtensionEndpointName,
  CostumeActionGroup,
  CostumeGadgetMount,
  CostumeExtensions,
  CostumeExtensionsFactory,
} from './CostumeExtensions';
export { isCostumeActionGroup, isCostumeGadgetMount, isCostumeExtensions } from './CostumeExtensions';
...
export type {
  GetEventSchemaInput as GetEventSchemaInputType,
  GetEventSchemaResult as GetEventSchemaResultType,
  EmitEventInput as EmitEventInputType,
  EmitEventResult as EmitEventResultType,
} from './event-gadgets';
