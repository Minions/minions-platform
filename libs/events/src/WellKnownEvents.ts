...
export const EventBusEvents = {
   ...
   */
  HandlerError: defineEvent<{
    /** Unique ID of the listener that threw the error */
    handlerId: string;
    /** Event type that was being handled when the error occurred */
    eventType: string;
    /** Effect Cause capturing the full error context, stack traces, and fiber info */
    cause: Cause.Cause<unknown>;
    /** The original event that triggered the handler */
